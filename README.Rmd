...
There are other excellent R packages for other and in some cases more comprehensive data such as [`igraphdata`](https://github.com/igraph/igraphdata) or [`networkdata`](https://github.com/schochastics/networkdata), and data in different formats in the project [Netzschleuder](https://networks.skewed.de). Likewise, there are many other classical social network databases in [UCINET](http://www.analytictech.com/archive/ucinet.htm), which is the most comprehensive and well established software for social network analysis of the last decades. 
