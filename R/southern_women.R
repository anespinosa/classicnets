#' Southern Women
#'
#' This data was collected in 1936 for ethnographic studies performed by A. Davis, B.B. Gardner and R. Gardner, together with Elizabeth Stubbs Davis and J.G.St. Clair Drake. From the so called "First Harvard School of Networks" (Freeman, 2004). It consists of two incident matrices. The first matrix is an informal group of 18 women attending 14 events. The second matrix is a different group of 6 women attending 9 events.
